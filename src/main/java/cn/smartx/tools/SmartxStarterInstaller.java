...
public class SmartxStarterInstaller extends AppInstaller {

	public SmartxStarterInstaller(){
		super("starter");
	}
	...
	public XApp createApp() {
		...
		thisApp.setLastModifyUser("SmartxStarterInstaller");
		thisApp.setName("Smartx基础包");
	...
	public void createRoleAndUser() {
        ...
        User usrTeacher = new User();
        usrTeacher.setLoginname("J05025");
        usrTeacher.setName("彭彬");
        usrTeacher.setPassword(SmartxConstants.SEC_ANONYMOUS_USER_PWD);
        usrTeacher.setAppcode(this.getAppCode());
        usrTeacher = us.createUser(usrTeacher);

        User usrStudent = new User();
        usrStudent.setLoginname("S000001");
        usrStudent.setName("学生");
        usrStudent.setPassword(SmartxConstants.SEC_ANONYMOUS_USER_PWD);
        usrStudent.setAppcode(this.getAppCode());
        usrStudent = us.createUser(usrStudent);

        User usrStudent2 = new User();
        usrStudent2.setLoginname("S000002");
        usrStudent2.setName("学生2");
        usrStudent2.setPassword(SmartxConstants.SEC_ANONYMOUS_USER_PWD);
        usrStudent2.setAppcode(this.getAppCode());
        usrStudent2 = us.createUser(usrStudent2);

        log.warn("create inner group.....");
        Group group001 = new Group();
        group001.setAppcode(this.getAppCode());
        group001.setGroupcode("D001");
        group001.setGrouptype("dept");
        group001.setName("综合部");
        group001 = us.createUserGroup(group001);
        
        Group group002 = new Group();
        group002.setAppcode(this.getAppCode());
        group002.setGroupcode("D002");
        group002.setGrouptype("dept");
        group002.setName("研发部");
        group002 = us.createUserGroup(group002);

        Group group0011 = new Group();
        group0011.setAppcode(this.getAppCode());
        group0011.setGroupcode("D0011");
        group0011.setGrouptype("dept");
        group0011.setName("总裁助理室");
        group0011 = us.createUserGroup(group0011);

        Group group0021 = new Group();
        group0021.setAppcode(this.getAppCode());
        group0021.setGroupcode("D0021");
        group0021.setGrouptype("dept");
        group0021.setName("杭州研发部");
        group0021.setPid(group002.getGroupsid());
        group0021 = us.createUserGroup(group0021);

        Group group00211 = new Group();
        group00211.setAppcode(this.getAppCode());
        group00211.setGroupcode("D00211");
        group00211.setGrouptype("dept");
        group00211.setName("杭州研发部-Zucc");
        group00211.setPid(group0021.getGroupsid());
        group00211 = us.createUserGroup(group00211);

        Group group0022 = new Group();
        group0022.setAppcode(this.getAppCode());
        group0022.setGroupcode("D0021");
        group0022.setGrouptype("dept");
        group0022.setName("上海研发部");
        group0022.setPid(group002.getGroupsid());
        group0022 = us.createUserGroup(group0022);

        log.warn("create inner group.....done");     
	}
